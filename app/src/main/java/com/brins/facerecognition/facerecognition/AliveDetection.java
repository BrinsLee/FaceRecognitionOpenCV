...
//    CountDownTimer timer;
    ...
    CountDownTimer taskWaiting = new CountDownTimer(14000, 2000) {
        ...
        public void onTick(long millisUntilFinished) {
            Recognition.warning.setText("请等待" + String.valueOf(time*2)+"s");
            time-=1;
            if(time==0)
            {
                poseRequest();
...
//                        taskWaiting.cancel();
    ...
    void SuccessInfo()
    {
        Recognition.warning.setText("检测成功");
    ...
    void FailedInfo()
    {
        ...
        Recognition.warning.setText("检测失败");

    }

    void PoseInfo(String info)
    {
        Recognition.warning.setText(info);
    }
